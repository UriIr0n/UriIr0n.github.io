...
const DashRecruit = (() => {
  ...
  function renderStatus(view) {
    ...
    const worst = gaps[0];
    ui.setStory(`ב-NovaTech פתוחות כרגע <b>${openNow} משרות</b> — ${C.pctF(openNow / D.headcount * 100, 1)} מהמצבה. הפער הכי כואב: <b>${worst.label}</b> עם ${C.pctF(worst.value, 1)} תקנים חסרים. נסו ללחוץ על פלח בדונאט או על מוט בגרף — הכול מתחתך יחד, בדיוק כמו ב-Power BI.`);
  }
